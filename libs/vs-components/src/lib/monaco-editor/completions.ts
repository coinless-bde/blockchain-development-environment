...
export const type_completions = [{
    label: "int",
    documentation: "integer type, a number",
    insertText: "int",
},
                                 {
    label: "bool",
    documentation: "boolean type, either true or false",
    insertText: "bool"
},
                                 {
    label: "string",
    documentation: "string type, a string of characters",
    insertText: "string"
},
                                 {
    label : "unit",
    documentation: "unit type, a basic unit of storage or computation, really just a placeholder for anything else",
    insertText: "unit"
}];

export const root_completions = [{
    label: "code",
    documentation: "contains michelson logic",
    ...
    insertText: 'parameter ${1:unit};\nstorage ${2:unit};\ncode {$0}',
    insertTextRules: languages.CompletionItemInsertTextRule.InsertAsSnippet,
},
                                 {
    label: "storage",
    documentation: "contains contract constrains",
    insertText: "storage ${1:unit};$0",
    kind: languages.CompletionItemKind.Constant,
    insertTextRules: languages.CompletionItemInsertTextRule.InsertAsSnippet,
},
                                 {
